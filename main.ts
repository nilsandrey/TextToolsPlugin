...
import {
	...
	sortLinesByWordCount, sortLinesByLastWord,
	shuffleLines,
...
export default class TextToolsPlugin extends Plugin {
	...
	private registerLineCommands() {
		...
		const simple: Array<[string, string, (t: string) => string]> = [
			...
			["sort-lines-lastword-asc",        "Sort lines by last word (A→Z)",           (t) => sortLinesByLastWord(t, "asc")],
			["sort-lines-lastword-desc",       "Sort lines by last word (Z→A)",           (t) => sortLinesByLastWord(t, "desc")],
